...
Installation
pip install hmmlearn pgmpy pandas_datareader scikit-learn statsmodels matplotlib

Running the Notebook

Open the notebook or script in Jupyter or Colab:

jupyter notebook WQU_FinalProject_VF.ipynb


or run the .py version:

python code.py

Repository Structure

code.py – Main research pipeline
